...
CREATE UNIQUE INDEX "chat_rooms_user_account_product_uk" ON "chat_rooms" USING btree ("user_id","account_id","product_id");--> statement-breakpoint
CREATE UNIQUE INDEX "users_oauth_provider_id_uk" ON "users" USING btree ("oauth_provider","email");--> statement-breakpoint
CREATE UNIQUE INDEX "users_referral_code_uk" ON "users" USING btree ("referral_code");